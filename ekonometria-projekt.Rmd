...
kraje które nie mają przypisanej wartości cluster_type (czyli NA), to te, dla których lokalny wskaźnik Morana  nie był istotny statystycznie czyli:

nie tworzą wyraźnego klastra o podobnych wartościach escs_trend (ani dodatniego – HH/LL, ani negatywnego – Outlier),

nie odbiegają wystarczająco od otoczenia, by zakwalifikować się jako outlier.
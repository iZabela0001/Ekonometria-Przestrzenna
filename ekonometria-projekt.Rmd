...
W celu zbadania, które czynniki mają wpływ na trend zmiennej zależnej **escs_trend** (wskaźnika społeczno-ekonomicznego uczniów),
przeprowadzono analizę regresji liniowej, w której jako zmienne niezależne uwzględniono: 
...
Model również wykazał bardzo wysokie dopasowanie do danych: 
- **R² = 0,9868**, co oznacza, że aż 98,68% zmienności wskaźnika escs_trend można wyjaśnić za pomocą zastosowanych zmiennych niezależnych.
- **Statystyka F= 3.62e+07** przy p < 2,2e-16 potwierdza, że model jako całość jest statystycznie istotny.

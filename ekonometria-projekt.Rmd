...
# Budowa modelu przestrzennego: SAR (model z opóźnieniem przestrzennym) lub SEM (model błędu przestrzennego)
```{r}

```


# Opcjonalnie: model Durbin lub GWR (geograficznie ważona regresja)
```{r}
